...
class DogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dog" do
    assert_difference('Dog.count') do
      post dogs_url, params: { dog: { colour: @dog.colour, date_of_birth: @dog.date_of_birth, name: @dog.name, owner_id: @dog.owner_id } }
    end
  ...
  test "should update dog" do
    patch dog_url(@dog), params: { dog: { colour: @dog.colour, date_of_birth: @dog.date_of_birth, name: @dog.name, owner_id: @dog.owner_id } }
